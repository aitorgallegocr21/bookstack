...
- [ ] 1.1 Configurar `darkMode: 'class'` en `tailwind.config.js`.
...
- [ ] 4.2 Implementar lógica reactiva de colapso/expansión para mostrar 2 sesiones por defecto y toggle para ver el historial restante.
