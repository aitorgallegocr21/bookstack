...
## Primary Workflow
1. Lee siempre `CONTEXT.md` y el plan operativo de la feature en `docs/feature-book-domain-workplan.md` antes de tomar decisiones.
...
5. Proporciona el bloque en Markdown listo para actualizar en `CONTEXT.md` y, si el cambio afecta a la feature, también actualiza el plan en `docs/feature-book-domain-workplan.md`.
